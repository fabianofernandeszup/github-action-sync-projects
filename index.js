...
async function run() {
  try {
    const inputs = {
      ...
      owner_source: core.getInput('repo-source', {required: true}).split('/')[0],
      repo_source: core.getInput('repo-source', {required: true}).split('/')[1],
      owner_target: core.getInput('repo-target', {required: true}).split('/')[0],
      repo_target: core.getInput('repo-target', {required: true}).split('/')[1],
